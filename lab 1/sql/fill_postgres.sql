...
SELECT 'pg' || g FROM generate_series(1, 10) g;

BEGIN; INSERT INTO pay(client, payload) VALUES (1, repeat('p', 24000)); COMMIT;
BEGIN; INSERT INTO pay(client, payload) VALUES (2, repeat('p', 24000)); COMMIT;
BEGIN; INSERT INTO pay(client, payload) VALUES (3, repeat('p', 24000)); COMMIT;
BEGIN; INSERT INTO pay(client, payload) VALUES (4, repeat('p', 24000)); COMMIT;
BEGIN; INSERT INTO pay(client, payload) VALUES (5, repeat('p', 24000)); COMMIT;
